...
# Form implementation generated from reading ui file 'listingRecolteUI.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(_translate("Form", "Listing des récoltes", None))
        self.label.setText(_translate("Form", "Listing des récoltes", None))
