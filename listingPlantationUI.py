...
# Form implementation generated from reading ui file 'listingPlantationUI.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(_translate("Form", "Listing des plantations", None))
        self.label.setText(_translate("Form", "Listing des plantations", None))
